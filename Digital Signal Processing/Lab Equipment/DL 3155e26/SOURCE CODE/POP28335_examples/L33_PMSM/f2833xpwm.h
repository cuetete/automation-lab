...
#define PWM_INIT_MACRO(ch1,ch2,ch3,v)										\
         ...
         (*ePWM[ch1]).CMPCTL.all = CMPCTL_INIT_STATE;/*0 load*/						\
         ...
         (*ePWM[ch1]).DBCTL.all = DBCTL_INIT_STATE;	/*complementary both polarity*/						\
