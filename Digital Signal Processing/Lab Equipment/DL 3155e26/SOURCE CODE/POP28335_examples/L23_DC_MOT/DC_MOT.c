...
/****************¶Ë¿Úºê¶¨Òå*****************/
#define Up_Key GpioDataRegs.GPADAT.bit.GPIO16		//K1
#define Down_Key GpioDataRegs.GPADAT.bit.GPIO17		//K2
#define Direction_Key GpioDataRegs.GPADAT.bit.GPIO12//K3
...
void Motor_Drive(void) 
{
	EPwm1Regs.CMPA.half.CMPA = temp;//change pulse width
	EPwm1Regs.CMPB = temp;
}
