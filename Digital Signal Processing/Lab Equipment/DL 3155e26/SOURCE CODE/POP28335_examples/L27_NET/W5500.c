...
void W5Delay(unsigned long ulCount)
{
    unsigned long i;
    for (i = 0; i < ulCount; i++) {}
}
...
#define CS_L GpioDataRegs.GPBCLEAR.bit.GPIO51 =1;
#define CS_H GpioDataRegs.GPBSET.bit.GPIO51 =1;

unsigned char W5500_Interrupt=0;
unsigned char Rx_Buffer[32];	
unsigned char Tx_Buffer[32];

Uint16 SPI1_Send_Byte(Uint16 TxData)
{
	Uint16 retry=0;
...
* 说明    : 无
*******************************************************************************/
void SPI1_Send_Short(Uint16 dat)
{
...
void W5500_Init(void)
{
	...
	W5Delay(56000*10);//延时10ms,自己定义该函数
	W5Delay(56000*10);//延时10ms,自己定义该函数
	W5Delay(56000*10);//延时10ms,自己定义该函数
	W5Delay(56000*10);//延时10ms,自己定义该函数
...
*			发送数据。
*******************************************************************************/
void Process_Read_Data(SOCKET s)
{
	Uint16 size=0;
