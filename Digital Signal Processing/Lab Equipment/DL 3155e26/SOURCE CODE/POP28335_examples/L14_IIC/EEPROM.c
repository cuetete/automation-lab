...
//		TranBuf:writing buffer, RecvBuf: reading buffer
//		Check whether the TranBuf and RecvBuf are the same
//		
////###########################################################################	
...
// This function is found in DSP280x_PieVect.c.
   ...
   for(;;)
   {
		...
		for(addr = 0;addr<=0xf;addr++)						//Check whether the TranBuf and RecvBuf are the same
		{
