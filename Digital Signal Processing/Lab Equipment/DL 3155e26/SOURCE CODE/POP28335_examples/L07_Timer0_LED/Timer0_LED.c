...
//          Count
//
//       Monitor the GPIO2 LED1 blink on (for 500 msec) and off (for 500 msec)
//
//###########################################################################
...
// Configure GPIO4-7 as a GPIO output pin, LED3-LED6
   ...
   //set other LED2-8 OFF
   GpioCtrlRegs.GPAMUX1.bit.GPIO3 = 0;
   GpioCtrlRegs.GPADIR.bit.GPIO3 = 1;
   GpioDataRegs.GPASET.bit.GPIO3 = 1;		//GPIO3 High
...
{
   Count++;
   GpioDataRegs.GPATOGGLE.bit.GPIO2 = 1; // Toggle GPIO2 LED1 once per 500 milliseconds
